...
class VendorController extends GetxController{
  ...
  List<VendorModel> _vendorVendorList = [];
  List<VendorModel> get vendorVendorList =>_vendorVendorList;
  ...
  Future<void> getVendorList()async {
    ...
    if(response.statusCode == 200){
      ...
      // print(response.body);
      print("here123");
      // Need to fix this, can't fetch data from postman host.
      _vendorVendorList.addAll(Vendors.fromJson({
        "contents": [
          {
            "vendor_id": 1,
