...
class AppColors{
  ...
  static final Color mainColor = const Color(0xFFb85043);
  static final Color iconColor1 = const Color(0xFFa7beae);
  ...
  static final Color yellowColor = const Color(0xFFe6e8d2);
  static final Color unavailable = const Color(0xFFD2D2D2);
}